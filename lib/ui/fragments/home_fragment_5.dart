...
class HomeFragment5 extends StatefulWidget {
  ...
  const HomeFragment5(this.navigateToNext, this.openDrawer);
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          child: TabBar(
                              ...
                              tabs: [
                                Tab(text:
                                AppLocalizations.of(context)?.translate("Top Selling")
                                ),
                                Tab(text:
                                AppLocalizations.of(context)?.translate("Super Deals")
                                ),
                                Tab(text:
