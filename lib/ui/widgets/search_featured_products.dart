...
import '../../api/responses/settings_response.dart';
...
import 'card_style_2.dart';
import 'card_style_new_1.dart';


class SearchFeaturedProducts extends StatefulWidget {
  final Function(Widget widget) navigateToNext;

  const SearchFeaturedProducts(this.navigateToNext);

  @override
  _SearchFeaturedProductsState createState() => _SearchFeaturedProductsState();
}

class _SearchFeaturedProductsState extends State<SearchFeaturedProducts> {
