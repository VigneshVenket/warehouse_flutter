...
class AddAddressBookScreenCheckout extends StatefulWidget {
  ...
  const AddAddressBookScreenCheckout(this.addressData,this.couponData,this.cartItems,this.gstDiscount,this.gstNumber,this.orderAmount);

  @override
  _AddAddressState createState() => _AddAddressState();
}

class _AddAddressState extends State<AddAddressBookScreenCheckout> {
            ...
            Navigator.of(context).push(MaterialPageRoute(
                builder: (c) =>MultiBlocProvider(
                    ...
                    child: CheckoutAddressScreen(
                      ...
                      gstDiscount: widget.gstDiscount,
